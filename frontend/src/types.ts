...
export interface QuestionResponse { answer: string; citations: Evidence[]; contract_citations: Evidence[]; policy_citations: Evidence[]; generation_mode: 'local_llm' | 'extractive_fallback' }
